...
CREATE INDEX `email_job_items_job_idx` ON `email_job_items` (`job_id`);--> statement-breakpoint
CREATE INDEX `email_job_items_campaign_idx` ON `email_job_items` (`campaign_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `email_jobs_status_run_idx` ON `email_jobs` (`status`,`run_at`);--> statement-breakpoint
